...
export interface QueryAutoCompleteSearchRequest
 ...
 */
export class QueryAutoCompleteSearch
  extends BaseSearch<QueryAutoCompleteSearchRequest>
  implements Searchable<QueryAutoCompleteResponse> {
  public async exec() {
