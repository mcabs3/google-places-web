...
var ReactNativeGooglePlaces = function () {
  function ReactNativeGooglePlaces(opts) {
    _classCallCheck(this, ReactNativeGooglePlaces);
  ...
  _createClass(ReactNativeGooglePlaces, [{
    key: '_log',
  ...
  return ReactNativeGooglePlaces;
}();
